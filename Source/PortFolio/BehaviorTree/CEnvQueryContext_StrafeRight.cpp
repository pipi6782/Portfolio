#include "CEnvQueryContext_StrafeRight.h"
#include "Global.h"
...
void UCEnvQueryContext_StrafeRight::ProvideContext(FEnvQueryInstance& QueryInstance, FEnvQueryContextData& ContextData) const
{
